			...
			<div class="flex min-h-screen min-w-[900px] flex-col max-lg:[--sticky-top-offset:calc(var(--desktop-header-height)+var(--desktop-horizontal-menu-height))]"
				...
				<header class="sticky top-0 z-20">
					<div class="relative z-10 flex h-[--desktop-header-height] items-center border-b bg-white px-4 py-4 2xl:px-12 dark:border-gray-800 dark:bg-black"
						bis_skin_checked="1">
						<div class="desktop-container flex w-full items-center gap-3 xl:gap-8" bis_skin_checked="1">
							<div class="flex shrink-0 items-center gap-2" bis_skin_checked="1">
							...
							<div class="flex max-w-96 items-center gap-2" bis_skin_checked="1">
								<span class="iconify i-ri:time-line icon text-primary hidden xl:block"
									aria-hidden="true" style=""></span>
								<div class="space-y-1 truncate whitespace-nowrap" bis_skin_checked="1">
								...
								if ($USER->IsAuthorized()) {
									...
									<a href="/profile/"
										...
										<div class="w-full" bis_skin_checked="1">
											<div id="userButton" class="flex items-center gap-1.5" bis_skin_checked="1">
